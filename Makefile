...
#    Updated: 2023/11/13 17:10:56 by junghwle         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
COMMAND_BUILDER_DIR=$(PARSE_DIR)/command_builder
HELPER_DIR=helper
PIPE_DIR=pipe
ERR_MSG_DIR=err_msg
OBJDIR=objs
...
COMMAND_BUILDER_SRC=command.c redirection.c command_argument.c
...
$(OBJDIR)/%.o: $(SRCDIR)/$(COMMAND_BUILDER_DIR)/%.c $(LIBFT) Makefile
	$(CC) $(DEPFLAGS) $(CFLAGS) $(INCLUDE) -c -o $@ $< $(CPPFLAGS)
	echo "(MINISHELL) COMPILING $@"
